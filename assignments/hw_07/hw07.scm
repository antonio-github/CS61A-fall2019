...
(define (longest-increasing-subsequence lst)
    ...
    ; Returns the longest increasing subsequence of LST
    ; Algortihm: tree recursive structure. Two cases: longest subseq WITH-FIRST 
    ; element of LST and longest subseq WITHOUT-FIRST element of LST. Check 
    ; which case has longer length.
    (if (null? lst)
        nil
        (begin
...
; Assuming that EXPONENT is a positive integer.
